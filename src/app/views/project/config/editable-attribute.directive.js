...
export function editAttribute($location, $anchorScroll, $uibTooltip) {
  return {
    restrict: 'A',
    scope: {
      attribute: '=',
    ...
    controllerAs: 'vm',
    template: require('./templates/attribute.html'),
...
export function editableAttribute($compile) {
  return {
    priority: 1001,
    ...
    compile: function (el, attrs) {
      ...
      el.attr('edit-popover-template', "'app/components/projects/config/templates/edit-attribute.html'");
...
function _attributeController($scope, $uibModal) {
  ...
  function remove() {
    var modal = $uibModal.open({
      template: require('./templates/delete-attribute-confirmation.html'),
      size: 'md',
