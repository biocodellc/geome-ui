...
export function editEntity($location, $anchorScroll, $uibTooltip) {
  return {
    restrict: 'A',
    scope: {
      entity: '=',
...
export function editableEntity($compile) {
  return {
    priority: 1001,
    ...
    compile: function (el, attrs) {
      ...
      el.attr('edit-entity', "");
      el.attr('edit-popover-template', "'app/components/projects/config/templates/edit-entity.html'");
...
function _entityController($scope, $uibModal) {
  ...
  function remove() {
    var modal = $uibModal.open({
      template: require('./templates/delete-entity-confirmation.html'),
      size: 'md',
