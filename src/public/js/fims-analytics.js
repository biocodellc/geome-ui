...
(function() {
  ...
  var createGaProxy = function createGaProxy(trackers) {
    return function(command) {
      ...
      try {
        ...
        for (
          var _iterator = trackers[Symbol.iterator](), _step;
  ...
  var createTrackers = function createTrackers() {
    ...
    try {
      for (
        var _iterator2 = ALL_TRACKERS[Symbol.iterator](), _step2;
  ...
  var trackErrors = function trackErrors() {
    ...
    try {
      for (
        var _iterator3 = loadErrorEvents[Symbol.iterator](), _step3;
  ...
  var sendInitialPageview = function sendInitialPageview() {
    gaAll(
      'send',
      'pageview',
      _defineProperty({}, dimensions.HIT_SOURCE, 'pageload'),
    );
  };
  ...
  var sendNavigationTimingMetrics = function sendNavigationTimingMetrics() {
    ...
    if (allValuesAreValid(responseEnd, domLoaded, windowLoaded)) {
      ...
      gaTest(
        ...
        _defineProperty(_gaTest, metrics.RESPONSE_END_TIME, responseEnd),
        _defineProperty(_gaTest, metrics.DOM_LOAD_TIME, domLoaded),
        _defineProperty(_gaTest, metrics.WINDOW_LOAD_TIME, windowLoaded),
        _gaTest),
      );
    }
  };
